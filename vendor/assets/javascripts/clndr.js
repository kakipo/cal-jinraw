...
;(function ( $, window, document, undefined ) {
  ...
  var clndrTemplate = "<div class='clndr-controls'>" +
    "<div class='clndr-control-button'><span class='clndr-previous-button'><i class='fa fa-arrow-circle-left'></i></span></div><div class='month'><%= month %> <%= year %></div><div class='clndr-control-button rightalign'><span class='clndr-next-button'><i class='fa fa-arrow-circle-right'></i></span></div>" +
    "</div>" +
